...
from telegram_bot.handlers.account_handlers import bulk_upload_accounts_file, WAITING_ACCOUNTS_FILE
...
/cancel - Отменить текущую операцию
        ...
        # Import the list_accounts_handler function from account_handlers
        from telegram_bot.handlers.account_handlers import list_accounts_handler
        
        # Call the handler with the update and context
...
# Создаем класс фильтра для проверки ожидания файла
class WaitingForAccountsFileFilter(MessageHandler):
    def check_update(self, update):
        ...
        # Проверяем флаг ожидания файла
        user_data = self.context.user_data
        return user_data.get('waiting_for_accounts_file', False)
